        ...
        <div className="mt-4 pt-3 border-t border-slate-800/80">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-emerald-400 uppercase tracking-wider">
              {activeTab === 'login' ? 'Resident Portal Login' : activeTab === 'activate' ? 'Account Activation' : 'Password Recovery'}
            </span>
            ...
            {actStep === 'verify' ? (
              <form onSubmit={handleVerifyForActivation} className="space-y-4">
                <div className="p-3.5 bg-emerald-50/70 border border-emerald-200 rounded-2xl text-xs text-emerald-900">
                  <p className="font-bold">Step 1 of 2: Verify Existing Record</p>
                ...
                <div className="p-3.5 bg-emerald-50 border border-emerald-200 rounded-2xl text-xs text-emerald-950">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-[11px] font-bold text-emerald-700 underline flex items-center gap-1 cursor-pointer"
                    >
          ...
          <form onSubmit={handleForgotPassword} className="space-y-4">
            ...
            <div className="pt-2 text-center">
              <button
                ...
                className="text-xs font-bold text-emerald-700 hover:text-emerald-800 underline cursor-pointer inline-flex items-center gap-1"
              >
                <ArrowLeft className="w-3 h-3" /> Back to Resident Login
              </button>
            </div>
          </form>
        )}
